...
public class ImageExerciseActivity extends AppCompatActivity {
    ...
    private int exerciseDurationSecs = 5;
    ...
    /**
     *   Load and display exercise main content (Title, Description, Image)
     */
    private void loadExerciseContent(Exercise exercise) {
        ...
        exerciseDescriptionTextView = (TextView) findViewById(R.id.image_exercise_description);
        exerciseDescriptionTextView.setText(exerciseDescriptionResource);

        // set image
        int exerciseImageResource = exercise.getExerciseImageResource();
        exerciseImageView = (ImageView) findViewById(R.id.exercise_image_view);
        exerciseImageView.setImageResource(exerciseImageResource);
    }
